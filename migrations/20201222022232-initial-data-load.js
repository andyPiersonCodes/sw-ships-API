...
module.exports = {
  up: async (queryInterface) => {
    ...
    return queryInterface.bulkInsert('affiliations', [
      ...
      { name: 'Galactic Empire', shipId: 38 },
